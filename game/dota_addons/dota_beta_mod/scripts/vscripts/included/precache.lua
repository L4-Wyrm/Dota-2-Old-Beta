...
{
	-- old beta assets
	"npc_dota_lycan_wolf2_old",
	"npc_dota_lycan_wolf3_old",
	"npc_dota_lycan_wolf4_old",
	"npc_dota_neutral_centaur_khan",
	"npc_dota_neutral_polar_furbolg_ursa_warrior",
	"npc_dota_neutral_mud_golem",
	"npc_dota_neutral_prowler_acolyte",
	"npc_dota_neutral_prowler_shaman",
	"npc_dota_twin_headed_dragon_model_background",
	"npc_dota_neutral_black_dragon",
	"npc_dota_neutral_rock_golem",
	"npc_dota_neutral_granite_golem",
	"npc_dota_model_background",
	"npc_dota_huskar_background",
	"npc_dota_ancient_apparition_background",
	"npc_dota_mega_greevil_background_winter",
	"npc_dota_roshan_greevil",
	"npc_dota_creep_badguys_ranged_halloween",
	"npc_dota_creep_badguys_melee_halloween",
	"npc_dota_badguys_siege_halloween",
	"npc_dota_creep_badguys_melee_upgraded_halloween",
	"npc_dota_creep_badguys_ranged_upgraded_halloween",
	"npc_dota_badguys_siege_upgraded_halloween",
	"npc_dota_creep_badguys_ranged_upgraded_mega_halloween",
	"npc_dota_creep_badguys_melee_upgraded_mega_halloween",
	"npc_dota_badguys_siege_upgraded_mega_halloween",
	"npc_dota_creep_goodguys_ranged_halloween",
	"npc_dota_creep_goodguys_ranged_upgraded_halloween",
	"npc_dota_creep_goodguys_ranged_upgraded_mega_halloween",
	"npc_dota_creep_goodguys_melee_halloween",
	"npc_dota_creep_goodguys_melee_upgraded_halloween",
	"npc_dota_creep_goodguys_melee_upgraded_mega_halloween",
	"npc_dota_goodguys_siege_halloween",
	"npc_dota_goodguys_siege_upgraded_halloween",
	"npc_dota_goodguys_siege_upgraded_mega_halloween",
...
g_ModelFolderPrecache =
{
	...
	"models/heroes/axe",
	"models/heroes/beastmaster",
	"models/heroes/brewmaster",
	"models/heroes/broodmother",
	"models/heroes/chen",
	"models/heroes/dazzle",
	"models/heroes/earthshaker",
	"models/heroes/enigma",
	"models/heroes/faceless_void",
	"models/heroes/gyro",
	"models/heroes/jakiro",
	"models/heroes/lion",
	"models/heroes/luna",
	"models/heroes/phantom_assassin",
	"models/heroes/puck",
	"models/heroes/pudge",
	"models/heroes/rikimaru",
	"models/heroes/shadow_fiend",
	"models/heroes/skeleton_king",
	"models/heroes/slardar",
	"models/heroes/sniper",
	"models/heroes/spectre",
	"models/heroes/storm_spirit",
	"models/heroes/twin_headed_dragon",
	"models/heroes/vengeful",
	"models/heroes/venomancer",
	"models/heroes/viper",
	"models/heroes/wraith_king",
	"models/heroes/zeus",
		
	--Cache models for items
	"models/items/deathbringer_arms",
	"models/items/deathbringer_head",
	"models/items/deathbringer_shoulders",
	"models/items/deathbringer_tail",

	--Cache models for creeps
	"models/creeps/neutral_creeps/n_creep_beast",
	"models/creeps/neutral_creeps/n_creep_dragonspawn_a",
	"models/creeps/neutral_creeps/n_creep_dragonspawn_b",
	"models/creeps/neutral_creeps/n_creep_forest_trolls",
	"models/creeps/neutral_creeps/n_creep_furbolg",
	"models/creeps/neutral_creeps/n_creep_satyr_a",
...
g_ParticleFolderPrecache =
{
	...
	"particles/units/heroes/hero_elder_titan",
	"particles/units/heroes/hero_jakiro",
	"particles/units/heroes/hero_nevermore",
	"particles/units/heroes/hero_skeletonking",
	"particles/units/heroes/hero_slardar",
	"particles/units/heroes/hero_spectre",
	"particles/units/heroes/hero_stormspirit",
	...
	"particles/econ/items/storm_spirit/storm_spirit_orchid_hat",
